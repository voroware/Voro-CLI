...
function SHA1RoundFunction(e, t, n) {
  ...
  for (a = 40; 60 > a; a++) {
    (v =
      (rotateLeft(u, 5) + ((p & m) | (p & g) | (m & g)) + f + c[a] + l) &
      4294967295),
      (f = g),
      (g = m),
      (m = rotateLeft(p, 30)),
...
function hexStringToMP(e) {
  var t,
    n,
    a = Math.ceil(e.length / 4),
    o = new JSMPnumber();
  for (o.size = a, t = 0; a > t; t++) {
    (n = e.substr(4 * t, 4)), (o.data[a - 1 - t] = parseInt(n, 16));
  }
  return o;
}
function MGF(e, t) {
...
function byteArrayToBase64(e) {
  ...
  return (
    1 == i
      ? (o = o + base64Encode(n << 16, 2) + "==")
      : 2 == i && (o = o + base64Encode(n << 8, 3) + "="),
    o
  );
}
...
function modularExp(e, t, n) {
  ...
  for (var i = duplicateMP(e), r = o - 2; r >= 0; r--) {
    (i = modularMultiply(i, i, n)), 1 == a[r] && (i = modularMultiply(i, e, n));
  }
  return i;
}
function JSMPnumber() {
...
function divideMP(e, t) {
  ...
  for (var s = n - 1; s >= a - 1; s--) {
    ...
    if (d > 0) {
      ...
      for (
        0 > c && (d--, multiplyAndSubtract(e, d, t, l));
        c > 0 && e.data[s] >= o;
...
function multiplyAndSubtract(e, t, n, a) {
  ...
  for (o = 0; o < n.size; o++) {
    ...
    (r = l >>> 16),
      (l -= 65536 * r),
      l > s[o + a] ? ((s[o + a] += 65536 - l), r++) : (s[o + a] -= l);
  }
  return (
    r > 0 && (s[o + a] -= r), s[o + a] < 0 ? ((e.data = i.slice(0)), -1) : 1
  );
}
...
function mapByteToBase64(e) {
  return e >= 0 && 26 > e
    ...
    : e >= 26 && 52 > e
    ? String.fromCharCode(97 + e - 26)
    : e >= 52 && 62 > e
    ? String.fromCharCode(48 + e - 52)
    : 62 == e
    ? "+"
    : "/";
}
